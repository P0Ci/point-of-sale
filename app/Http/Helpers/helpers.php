...
{
    $angka = abs($angka);
    $baca = array('', 'satu', 'dua', 'tiga', 'empat', 'lima', 'enam', 'tujuh', 'delepan', 'sembilan', 'sepuluh', 'sebelas');
    $terbilang = '';
    ...
    } elseif ($angka < 1000) { // 200 - 299
        $terbilang = terbilang($angka / 100) . ' seratus' . terbilang($angka % 100);
